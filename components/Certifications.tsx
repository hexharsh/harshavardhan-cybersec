...
const certs = [
  ...
  {
    name: "AZ-500",
    full: "Microsoft Azure Security Engineer Associate",
    issuer: "Microsoft Certified",
    icon: Award,
    color: "cyan",
    desc: "Microsoft certified in Azure security — managing identity, access, data protection, and network security controls across cloud environments.",
    skills: ["Azure AD", "Cloud Security", "IAM", "Network Controls"],
  },
  {
    name: "SC-200",
    full: "Microsoft Security Operations Analyst Associate",
    issuer: "Microsoft Certified",
    icon: Target,
    color: "blue",
    desc: "Microsoft certified in security operations — threat detection, incident response, and security monitoring using Microsoft Sentinel and Defender.",
  ...
  },
  {
    ...
    icon: BookOpen,
    color: "green",
    desc: "Trained Security Tester with hands-on VAPT expertise across web, API, mobile, and network environments.",
