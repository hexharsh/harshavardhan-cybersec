...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Bash", level: 50, icon: Terminal },
      { name: "SQL", level: 48, icon: Database },
      { name: "JavaScript", level: 35, icon: Code2 },
    ],
  },
  {
    ...
    color: "cyan",
    skills: [
      { name: "Prompt Injection Testing", level: 82, icon: Brain },
      { name: "Ollama + Kali Integration", level: 78, icon: Terminal },
      { name: "Agentic AI Workflow Design", level: 80, icon: Zap },
      { name: "AI Security Automation Ideas", level: 78, icon: Brain },
      { name: "AI-Assisted Automation", level: 75, icon: Zap },
      { name: "LLM-Aided Scripting", level: 70, icon: Code2 },
      { name: "Landing Page Development", level: 72, icon: Globe },
      { name: "HTML / CSS / JS", level: 68, icon: Code2 },
    ],
  },
];
