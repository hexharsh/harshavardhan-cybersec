...
const experiences = [
  ...
  },
  {
    ...
    responsibilities: [
      ...
      "Burp Suite Pro & OWASP ZAP DAST — comprehensive automated scanning alongside manual testing",
      ...
      "Weekly VAPT reports & customised security summaries for cross-functional stakeholders",
